package com.example.githubusersubmission.alarm
...
import com.example.githubusersubmission.MainActivity
...
class AlarmReceiver : BroadcastReceiver(){
    ...
    companion object {
        ...
        private const val TIME_DAILY = "09.00" //alarm time set
    }
    ...
    private fun showAlarmNotification (
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES. O) {
            ...
            notficationManagerCompat.createNotificationChannel(channel)
        }

        val notification = builder.build()
        notficationManagerCompat.notify(100, notification)
    }
}